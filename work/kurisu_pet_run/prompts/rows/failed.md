Create one horizontal animation strip for Codex pet `kurisu`, state `failed`.
...
State action: Intellectual frustration, never sadness: inspect the failure, narrow the eyes into a small frown, close them briefly with a restrained sigh, touch the forehead lightly, then recover into skeptical composure. Keep posture controlled; no crying, panic, collapse, or melodrama.

State requirements:
- Show failure through a slight frown, brief closed eyes, a small head dip, and one restrained forehead-touch or sigh gesture; preserve an upright adult silhouette.
